...
import type { ChildProcessHandle } from './platform'
  ...
  connect(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        platform.storage.ensureDataFolderExists()
        const dataDir = platform.storage.getDataFolder()
        this.proc = platform.process.spawn(this.config.command, this.config.args, {
          env: {
            ...this.config.env
          },
          cwd: dataDir,
